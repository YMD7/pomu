          ...
          <div class="col-xs-12 col-md-8">
            <div class="ask">
              ...
              <div class="carousel">
                ...
                <div><a class="fancybox" rel="etc-gallery" href="<?php echo get_template_directory_uri(); ?>/assets/image/etc_pic4.jpg" title="結婚式はがき"><img src="<?php echo get_template_directory_uri(); ?>/assets/image/etc_pic4.jpg"></a></div>
                <div class="hidden"><a class="fancybox" rel="etc-gallery" href="<?php echo get_template_directory_uri(); ?>/assets/image/etc_pic5.jpg" title="結婚式席次表"><img src="<?php echo get_template_directory_uri(); ?>/assets/image/etc_pic5.jpg"></a></div>
                <div class="hidden"><a class="fancybox" rel="etc-gallery" href="<?php echo get_template_directory_uri(); ?>/assets/image/etc_pic6.jpg" title="結婚式プロフィール"><img src="<?php echo get_template_directory_uri(); ?>/assets/image/etc_pic6.jpg"></a></div>
